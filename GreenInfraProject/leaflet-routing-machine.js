...
polyline.decode = function(str, precision) {
    ...
    //console.log("1st coordinate " + coordinates[0]);
    return coordinates;
};
...
polyline.toGeoJSON = function(str, precision) {
    ...
    document.querySelector('#Elevation').value = coords;
    return {
        type: 'LineString',
...
(function() {
	...
	module.exports = OSRMv1.extend({
		options: {
			serviceUrl: 'pk.eyJ1IjoibmVlc2h5MTIzIiwiYSI6ImNrbGE3anNxczJuZnYycHFqMnZuZTA0aG4ifQ.lBhkogAfzWk9AUgb7UScng',
